...
(import "ci/python-bench.libsonnet") +
{
    ...
    local gate_task_dict = {
        ...
        "python-unittest-retagger": ut_retagger + platform_spec(no_jobs) + batches(RETAGGER_SPLIT) + platform_spec({
            "linux:amd64:jdk-latest"     : weekly    + t("20:00:00") + require(GRAALPY_NATIVE_STANDALONE),
            "linux:aarch64:jdk-latest"   : weekly    + t("20:00:00") + require(GRAALPY_NATIVE_STANDALONE),
            "darwin:aarch64:jdk-latest"  : weekly    + t("20:00:00") + require(GRAALPY_NATIVE_STANDALONE),
            "windows:amd64:jdk-latest"   : weekly    + t("20:00:00") + require(GRAALPY_NATIVE_STANDALONE),
        }),
